    ...
    <div className="sticky top-0 z-50 bg-white ">
      <Transition.Root show={open} as={Fragment}>
            ...
            >
              <Dialog.Panel className="relative flex flex-col w-full max-w-xs pb-12 overflow-y-auto bg-white shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="px-4 py-6 space-y-6 border-t border-gray-200">
                  ...
                  {user?.user?.email ==="rahul1@gmail.com" ?
                  ...
                  {user ?
                  <div className="flow-root">
                    <a onClick={logout} className="block p-2 -m-2 font-medium text-gray-900 cursor-pointer" style={{ color: mode === 'dark' ? 'white' : '', }}>
                      Logout
                    </a>
                  </div>:<div className="flow-root">
                    <Link to={'/signup'}  className="block p-2 -m-2 font-medium text-gray-900 cursor-pointer" style={{ color: mode === 'dark' ? 'white' : '', }}>
                      Signup
                    </Link>
                  </div>}
                  
                  <div className="flow-root">
                    <Link to={'/login'} className="block p-2 -m-2 font-medium text-gray-900 cursor-pointer">
                     <img
       ...
       <header className="relative bg-white">
        <p className="flex items-center justify-center h-10 px-4 text-sm font-medium text-white bg-green-600 sm:px-6 lg:px-8" style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', color: mode === 'dark' ? 'white' : '', }}>
          Get Free Delivery ON Order Above Rs 1000
        </p>
            ...
            <div className="flex items-center h-16">
              ...
              <div className="flex ml-4 lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <h1 className='px-2 py-1 text-2xl font-bold text-black rounded ' style={{ color: mode === 'dark' ? 'white' : '', }}>BUCKET-LIST</h1>
                  </div>
                </Link>
              </div>
